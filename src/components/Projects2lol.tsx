              ...
              <div className="p-4 flex-grow flex flex-col">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link href={`/projects/${project.ref}`}>
                    <button className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium border h-10 px-4 py-2 relative group overflow-hidden bg-transparent text-gray-50 rounded-full hover:text-gray-50 transition-transform duration-500 hover:scale-105 hover:cursor-pointer">
